...
| 1 | Static outdoor scene + 5 hotspots, placeholder shapes, no anatomy zoom | **Done** — Initial Scene bubbles as hotspots |
| 2 | Zoom/transition from outdoor scene into the shared cutaway | On `/projects` above program cards — plan: `lung-health-visual-phase2.md` |
